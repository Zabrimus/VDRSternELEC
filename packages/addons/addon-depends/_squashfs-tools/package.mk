...
PKG_DEPENDS="toolchain zlib lzo xz _zstd"
...
make_target() {
  ...
  make -C squashfs-tools \
          ...
          XATTR_SUPPORT=1 \
          XATTR_DEFAULT=1 \
          INCLUDEDIR="-I. -I$(get_install_dir zlib)/usr/include -I$(get_install_dir lzo)/usr/include -I$(get_install_dir xz)/usr/include -I$(get_install_dir _zstd)//usr/local/include" \
          all
}
