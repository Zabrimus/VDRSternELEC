...
sed -i -E "s/^(PKG_DEPENDS_HOST.*)$/\0\nPKG_DEPENDS_TARGET=\"toolchain\"/" packages/graphics/vulkan/spirv-headers/package.mk
sed -i -E "s/^(PKG_DEPENDS_HOST.*)$/\0\nPKG_DEPENDS_TARGET=\"toolchain\"/" packages/graphics/vulkan/spirv-tools/package.mk
